...
const modalInfo = [
{
            ...
            desc: 'Ultra Fuel is a full-stack web-app developed using React and SCSS to create a responsive, optimized interface.  It allows users to easily add water, Tailwind and food consumed during an ultramarathon, and displays the total calories and nutrients for each hour to quickly and easily see how the runner is fueling.  Data is retrieved using API calls to five serverless functions to access collections on FaunaDB.  The data collections retrieved are objects and the reduce function is used when a food item is removed.',
            img: '/img/ultraFuel.png',
            code: 'https://github.com/alleycaaat/ultra-fuel',
            demo: 'https://achulslander-ultra-fuel.netlify.app/',
    ...
    },
	{
        ...
        img: '/img/connectFour.png',
        url: 'https://achulslander-connect-four.netlify.app/',
    ...
    },
     {
        ...
        title: 'Memory Game',
		stack: 'ReactJS, FaunaDB, Netlify',
        desc: 'A memory card game with three truly challenging decks!  Players select their decktype, the amount of cards they want, and if they want a normal or challenging game.  The challenging games do not have perfectly matching cards, making pairing the cards rather difficult.  The colors deck is made up of pairs with a color swatch and the HEX for the color.  The math deck has different equations to be matched to their answers.  The coding deck has programming logos to match to the typed name of the logo.  This game was created using ReactJS, Netlify and FaunaDB.',
        img: '/img/memoryGame.png',
        url: 'https://achulslander-memory-card-game.netlify.app/',
    ...
    },
     {
        ...
        img: '/img/notesKeeper.png',
        url: 'https://achulslander-notes-keeper.netlify.app/',
    ...
    },
     {
        ...
        img: '/img/racePace.png',
        url: 'https://codepen.io/alleycaaat/full/RwxJYqQ',
    ...
    },
     {
        ...
        img: '/img/faq.png',
        url: 'https://codepen.io/alleycaaat/full/bGazoZa',
    ...
    },
     {
        ...
        img: '/img/memoryGameSimple.png',
        url: 'https://achulslander-memory-game.netlify.app/',
    ...
    return (
        <section class='fullportfolio' id='portfolio'>
                ...
                <div class='row'>
                    {modalInfo.map((proj, i) => (
                        <div class='fullproj' id={proj.id} key={i}>
                            <img
                                className='ope'
                                loading='lazy'
                                decoding='async'
                                src={`https://achulslander.com${proj.img}`}
                                alt={proj.alt}
                            />
                            <div class='projDesc'>
                            <h4>{proj.title}</h4>
